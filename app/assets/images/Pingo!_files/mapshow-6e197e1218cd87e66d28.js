...
/***/ 45:
/*!*****************************************!*\
  !*** ./app/javascript/packs/mapshow.js ***!
  \*****************************************/
/*! no exports provided */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var mapElement = document.getElementById('mapshow');
if (mapElement) {
  ...
  var destination = new google.maps.LatLng(to);
  var self_icon = { url: "https://res.cloudinary.com/dekx98imz/image/upload/v1519916998/noun_128968_cc.png", scaledSize: { width: 50, height: 50 } };
  ...
  var request = { origin: from_self, destination: destination, travelMode: google.maps.TravelMode.DRIVING };

  Object(__WEBPACK_IMPORTED_MODULE_0__map_toolkit__["showOneLeg"])(request, map, "#0000ff");

  counterparts.forEach(function (counterpart) {
    var from_counterpart = new google.maps.LatLng(counterpart.from);
    var request_counterpart = {
      origin: from_counterpart,
      destination: from_self,
      travelMode: google.maps.TravelMode.WALKING
    };

    Object(__WEBPACK_IMPORTED_MODULE_0__map_toolkit__["showOneLeg"])(request_counterpart, map, "#ff0000");

    var counterpart_icon = {
      url: counterpart.avatar,
      scaledSize: {
        width: 30,
        height: 30
...
/******/ });
//# sourceMappingURL=mapshow-6e197e1218cd87e66d28.js.map